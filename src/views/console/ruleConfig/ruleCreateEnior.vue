<template>
   <div id="totalMain">
       <!--删除弹出框-->
                                    ...
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            ...
                                            <el-form-item label="Dport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入目的端口" v-model="item.dstPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入目的端口掩码" v-model="item.dstPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入协议号" v-model="item.protocol" class="ruler_small"></el-input>
                                            </el-form-item>
                                             <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入协议号掩码" v-model="item.protocolMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                        </div>  
                                        <div class="col-md-4 no-4">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入源端口" v-model="item.srcPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入源端口掩码" v-model="item.srcPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
        ...
        <!--块逻辑 特征码(固定位置特征码)-->
        <div id="tz_fixed" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in tz_fixedList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,tz_fixedList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(inde,item.listName,tz_fixedList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                                    ...
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="特征码：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.keyword" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="处理方式："  class="rule_group crulte clType">
                                        ...
                                        <div class="col-md-8 no-4">
                                            <el-form-item label="偏移位置：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.offset" class="ruler_long"></el-input>
                                            </el-form-item></br>
                                             <div v-if="item.clfs==1||item.clfs==2">
                                            <el-form-item label="输出："  class="rule_group crulte">
                                                <el-select v-model="item.sc" placeholder="请选择输出"  class="ruler_small" @change="outChange(item)">
        ...
        <!--块逻辑 特征码(窗口范围浮动特征码)-->
        <div id="tz_float" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in tz_floatList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,tz_floatList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,tz_floatList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <!--块逻辑 特征码(全包范围浮动特征码)-->
        <div id="tz_both" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in tz_bothList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,tz_bothList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,tz_bothList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
            ...
            <div id="createRules_main" v-for="(item,index) in xlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,xlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,xlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                                    ...
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            ...
                                            <el-form-item label="*三层：" class="rule_group crulte down" >
                                                <el-input  placeholder="请输入端口名称" v-model="item.vlan3" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="*四层：" class="rule_group crulte down">
                                                <el-input  placeholder="请输入端口名称" v-model="item.vlan4" class="ruler_long"></el-input>
                                            </el-form-item>
            ...
            <div id="createRules_main" v-for="(item,index) in imsiList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,imsiList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,imsiList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
            ...
            <div id="createRules_main" v-for="(item,index) in urlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,urlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,urlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <!--块逻辑 应用层协议-->
        <div id="yyHttp" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in yyHttpList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        <div style="float:left;margin-top:6px;">
                        <el-form ref="ym" :model="item" label-width="80px">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,yyHttpList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,yyHttpList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                                    ...
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="应用层协议："  class="rule_group crulte clType">
                                                <el-select v-model="item.appProto" placeholder="请选择应用层协议"  class="ruler_long">
                                                    <el-option v-for="(item,index) in yyClist" :label="item.name" :value="item.name" :key="item.value"></el-option>
                                                </el-select>
                                            </el-form-item>
                                        </div>  
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="处理方式"  class="rule_group crulte clType">
                                                <el-select v-model="item.clfs" placeholder="请选理方式"  class="ruler_small" @change="clfsChange(index,yyHttpList,item.clfs)">
                                                    <el-option v-for="(item,index) in event" :label="item.name" :value="item.value" :key="item.value"></el-option>
                                                </el-select>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte cltypeAfter"  id="cRules">
        ...
        <!--块逻辑 复合规则-精准IP-信令协议-->
        <div id="accurate_xl" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_xlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_xlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_xlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="SIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.srcIpv4" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Dport："  class="rule_group crulte">
                                                <el-input  placeholder="请输入Dport" v-model="item.dstPort" class="ruler_long"></el-input>
                                            </el-form-item>  
                                            <el-form-item label="信令协议："  class="rule_group crulte">
                                                <el-select v-model="item.appProto" placeholder="请选择处理方式"  class="ruler_long">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="DIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.dstIpv4" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入协议号" v-model="item.protocol" class="ruler_long"></el-input>
                                            </el-form-item>
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入Sport" v-model="item.srcPort" class="ruler_long"></el-input>
                                            </el-form-item>
                                             <el-form-item label="relateId：" class="rule_group crulte">
                                                <el-input  placeholder="请输入relateId" v-model="item.relateId" class="ruler_long"></el-input>
                                            </el-form-item>  
                                             <div v-if="item.clfs==1||item.clfs==2">
                                            <el-form-item label="输出："  class="rule_group crulte">
                                                <el-select v-model="item.sc" placeholder="请选择输出"  class="ruler_small" @change="outChange(item)">
        ...
        <!--块逻辑 复合规则-精准IP-imsi-->
        <div id="accurate_imsi" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_imsiList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_imsiList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_imsiList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                                    ...
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="SIP：" class="rule_group crulte">
                                              ...
                                              <el-form-item label="Dport："  class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.dstPort" class="ruler_long"></el-input>
                                            </el-form-item>
                                             <el-form-item label="*IMSI："  class="rule_group crulte">
                                        ...
                                        <div class="col-md-4 no-4">
                                            ...
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.protocol" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="处理方式"  class="rule_group crulte clType">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.srcPort" class="ruler_long"></el-input>
                                            </el-form-item>
                                              <el-form-item label="relateId：" class="rule_group crulte">
                                                <el-input  placeholder="请输入relateId" v-model="item.relateId" class="ruler_long"></el-input>
                                            </el-form-item>
        ...
        <!--块逻辑 复合规则-精准IP-url-->
        <div id="accurate_url" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_urlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_urlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_urlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <div id="accurate_fixed" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_fixedList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_fixedList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_fixedList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <div id="accurate_float" style="width:100%"> 
            <div  id="createRules_main" v-for="(item,index) in jz_floatList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_floatList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_floatList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <div id="accurate_both" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_bothList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_bothList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_bothList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="SIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入SIP" v-model="item.srcIpv4" class="ruler_long"></el-input>
                                            </el-form-item>
                                             <el-form-item label="Dport："  class="rule_group crulte">
                                                <el-input  placeholder="请输入Dport" v-model="item.dstPort" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="特征码：" class="rule_group crulte">
                                                <el-input  placeholder="请输入特征码" v-model="item.keyword" class="ruler_long"></el-input>
                                            </el-form-item>
                                        </div>  
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="DIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入DIP" v-model="item.dstIpv4" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入Protecl" v-model="item.protocol" class="ruler_long"></el-input>
                                            </el-form-item>
                                            <el-form-item label="处理方式"  class="rule_group crulte clType">
         ...
         <!--块逻辑 复合规则-精准IP-应用层协议-->
        <div id="accurate_yy" style="width:100%">
            <div  id="createRules_main" v-for="(item,index) in jz_yyList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,jz_yyList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,jz_yyList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
         ...
         <!--块逻辑 复合规则-掩码IP-信令协议-->
         <div id="mask_xl" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_xlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_xlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_xlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="SIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.srcIpv4" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.srcIpv4Msk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Dport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.dstPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.dstPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="信令协议："  class="rule_group crulte">
                                                <el-select v-model="item.appProto" placeholder="请选择处理方式"  class="ruler_long">
                                                    <el-option v-for="(item,index) in typeArray[3].data" :label="item.name" :value="item.name" :key="item.value"></el-option>
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="DIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.dstIpv4" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入端口名称" v-model="item.dstIpv4Msk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.protocol" class="ruler_small"></el-input>
                                            </el-form-item>
                                             <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.protocolMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="处理方式"  class="rule_group crulte clType">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.srcPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.srcPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="relateId：" class="rule_group crulte">
                                                    <el-input  placeholder="请输入relateId" v-model="item.relateId" class="ruler_long"></el-input>
                                            </el-form-item>
        ...
        <!--块逻辑 复合规则-掩码IP-imsi-->
         <div id="mask_imsi" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_imsiList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_imsiList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_imsiList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
        ...
        <!--块逻辑 复合规则-掩码IP-url-->
        <div id="mask_url" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_urlList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_urlList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_urlList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.srcPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.srcPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
        ...
        <div id="mask_fixed" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_fixedList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_fixedList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_fixedList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        <div class="col-md-4 no-4"> 
                                            <el-form-item label="SIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.srcIpv4" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入端口名称" v-model="item.srcIpv4Msk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Dport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入端口名称" v-model="item.dstPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.dstPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
                                        ...
                                        <div class="col-md-4 no-4">
                                            ...
                                            <el-form-item label="偏移位置：" class="rule_group crulte">
                                                <el-input  placeholder="请输入偏移位置" v-model="item.offset" class="ruler_long"></el-input>
                                            </el-form-item>
                                        </div>
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
        ...
        <div id="mask_float" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_floatList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_floatList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_floatList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="DIP：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.dstIpv4" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.dstIpv4Msk" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item label="Protecl：" class="rule_group crulte">
                                                <el-input  placeholder="请输入" v-model="item.protocol" class="ruler_small"></el-input>
                                            </el-form-item>
        ...
        <div id="mask_both" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_bothList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_bothList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_bothList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
                        <el-form ref="creatRulesFir" :model="item" label-width="80px">
                                <div class="row">
                                    <div class="col-md-12" style="padding:0!important">
                                        ...
                                        <div class="col-md-4 no-4">
                                            <el-form-item label="Sport：" class="rule_group crulte">
                                                <el-input  placeholder="请输入Sport" v-model="item.srcPort" class="ruler_small"></el-input>
                                            </el-form-item>
                                            <el-form-item  class="rule_group crulte"  id="cRules">
                                                <el-input  placeholder="请输入" v-model="item.srcPortMsk" class="ruler_small"></el-input>
                                            </el-form-item>
         ...
         <!--块逻辑 复合规则-掩码IP-应用层协议-->
        <div id="mask_yy" style="width:100%">
            <div id="createRules_main" v-for="(item,index) in ym_yyList">
                <div class="createRules_mainQuire">
                    <div class="createRules_mainQuire_titile">
                        ...
                        <div style="float:right;margin-top:12px;">
                            <!--<el-button type="primary">新增</el-button>-->
                            <el-button type="primary" @click="copyAdd(index,ym_yyList,item.listName)">复制并新增</el-button>
                            <el-button @click="deleteRule(index,item.listName,ym_yyList)">删除</el-button>
                        </div>
                    </div>
                    <div class="createRules_mainQuire_main">
                        <div style="clear:both;">
            ...
            add:function(e,ids){
                switch(e)
                    ...
                    case 9:
                      ...
                      this.addFunction(this.yyHttpList,letyycHttp,ids,'no');
                    break;
                    }
            },
            addLd:function(e,ids){
                if(e>300&&e<310){
                      var letxl = {
                            ...
                            action:"NONE",
                            listName:"signalling",
                            appProto:this.crSec_afterOption.name,
                            name:this.crSec_option.name,  //一级类型名字
                ...
                switch(e)
                    ...
                    case 801:
                     var letjz_xl = {
                            ...
                            dipAfter:"",
                        dipAfterNext:"",
                            listName:"matchFiveTupleV4_signalling",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
                    ...
                    break;
                     ...
                     var letjz_yy = {
                            ...
                            dipAfter:"",
                        dipAfterNext:"",
                            listName:"matchFiveTupleV4_appProto",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
                    ...
                    break;
                     ...
                     var letjz_imsi = {
                           ...
                           dipAfter:"",
                        dipAfterNext:"",
                            listName:"matchFiveTupleV4_imsi",
                             name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
                    ...
                    break
                     ...
                     var letjz_fixed = {
                            ...
                            dipAfter:"",
                        dipAfterNext:"",
                            listName:"matchFiveTupleV4_keywordSingle",
                            keyword:"",
                            offset:"",
                             name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                    ...
                    break
                     ...
                     var letjz_float = {
                        ...
                        dipAfterNext:"",
                            protocol:"",
                            listName:"matchFiveTupleV4_keywordFloat",
                            keyword:"",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                    ...
                    case 807:
                     var letjz_both = {
                           ruleId:"",
                            ...
                            dipAfter:"",
                        dipAfterNext:"",
                            listName:"matchFiveTupleV4_keywordMaxLen",
                            keyword:"",   //特征码
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                    ...
                    break
                      case 814:
                        ...
                        dipAfterNext:"",
                            ...
                            dstPortMsk:"",
                            protocolMsk:"",
                            listName:"maskIpv4_keywordSingle",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
                            boolean:true, //控制处理方式输入框的可写性
                            keyword : "", //特征码³¤¶È²»ÄÜ´óÓÚ64×Ö½Ú, ¿ÉÒÔÊäÈë"\\35"´ú±í0x35
		                    offset : ""  //偏移位置       
                        };
                    ...
                    break
                      case 815:
                        ...
                        dipAfterNext:"",
                            ...
                            dstPortMsk:"",
                            protocolMsk:"",
                            listName:"maskIpv4_keywordFloat",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
                    ...
                    break
                     case 816:
                        ...
                        dipAfterNext:"",
                            ...
                            dstPortMsk:"",
                            protocolMsk:"",
                            listName:"maskIpv4_keywordMaxLen",
                            name:this.crSec_option.name,  //一级类型名字
                            childrenName:this.crSec_afterOption.name,  //二级名字
                            childLastName:this.crSec_bdOption.name,  //三级名字
                            outBoolean:true, //控制输出选项
