...
<div class="accountInfor-box">
    ...
    <div class="accountInfor-list">
        <span class="accountInfor-list-key">密码设置：</span>
        <span class="accountInfor-list-val">aaaaa</span>
        <router-link target="_blank" to="/forgetPassword">修改密码</router-link>
    </div>
    <div class="accountInfor-list">
        <span class="accountInfor-list-key">绑定手机：</span>
        ...
        <button v-on:click="dialog('phone')" v-if="safe.phone!=null">解绑</button>
        <button v-on:click="dialog('phone')" v-else>绑定</button>
    </div>
    <div class="accountInfor-list">
        <span class="accountInfor-list-key">绑定邮箱：</span>
        ...
        <button v-on:click="dialog('email')" v-if="safe.email!=null">解绑</button>
        <button v-on:click="dialog('email')" v-else>绑定</button>
    </div>
</div>
<!-- 弹框 -->
<el-dialog title="身份验证" :visible.sync="dialogUnbing" style="text-align:left;">
    ...
    <div v-if="updataname=='email'">
        ...
        <div class="validata-type">绑定邮箱：
            ...
            <input class="intemail" type="text" v-else v-model="safe.email">
        </div>
    ...
    <div v-if="updataname=='phone'">
        ...
        <div class="validata-type">绑定手机：
            ...
            <input class="intemail" type="text" v-else v-model="safe.phone">
        </div>
