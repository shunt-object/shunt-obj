...
<div class="accountInfor-box">
    ...
    <div class="accountInfor-list">
        ...
        <!--1=个人；2=企业；3=运营商；4=政府；5=运营;6=代理商 7=独立顾问-->
        ...
        <span class="accountInfor-list-val-type" v-if="information.utype==6">代理商</span>
        <span class="accountInfor-list-val-type" v-if="information.utype==7">独立顾问</span>
    </div>
    <div class="accountInfor-list">
        <span class="accountInfor-list-key">
